...
void CR_Deadly( void )
{
	WriteInstruction( "lda #DEADLY	; DEADLY" );
...
void CR_Custom( void )
{
	WriteInstruction( "lda #CUSTOM	; CUSTOM" );
	WriteInstruction( "sta z80_b");
	WriteInstruction( "jsr tded" );
	WriteInstruction( "cmp z80_b" );
	WriteInstruction( "beq :+" );
...
void CR_Collision( void )
{
	...
	if ( nArg == INS_NUM )
	{
		...
		{
			WriteInstruction( "jsr lcol	; COLLISION" );
...
void CR_Anim( void )
{
	...
	if ( nArg == 0 )
	{
		WriteInstruction( "lda #0		; ANIMATE" );
	}
	else
	{
		WriteInstruction( "lda #" );
...
void CR_AnimBack( void )
{
	...
	if ( nArg == 0 )
	{
		WriteInstruction( "lda #0		; ANIMATEBACK" );
	}
	else
	{
		WriteInstruction( "lda #," );
...
void CR_PutBlock( void )
{
//	WriteInstruction( "lda charx	; PUTBLOCK" );
...
void CR_DisplayHighScore( void )
{
	...
	if ( nArg == 6 )
	{
		WriteInstruction( "ldy #0		; SHOWHIGH");
		WriteInstruction( "lda #6" );
		WriteInstruction( "sta z80_b" );
	}
	else
	{
		WriteInstruction( "ldy #");
		WriteNumber( 6 - nArg );
		WriteText( "	; SHOWSCORE");
		WriteInstruction( "lda #" );
		WriteNumber( nArg );
...
void CR_DisplayScore( void )
{
	...
	if ( nArg == 6 )
	{
		WriteInstruction( "ldy #0		; SHOWSCORE");
		WriteInstruction( "lda #6" );
		WriteInstruction( "sta z80_b" );
	}
	else
...
void CR_DisplayBonus( void )
{
	...
	if ( nArg == 6 )
	{
		WriteInstruction( "ldy #0		; SHOWBONUS");
		WriteInstruction( "lda #6" );
		WriteInstruction( "sta z80_b" );
	}
	else
...
void CR_Kill( void )
{
	WriteInstruction( "lda #1 		; KILL" );						/* player dead flag. */
...
void CR_Display( void )
{
	...
	switch( nArg )
	{
		case INS_DOUBLEDIGITS:
			WriteInstruction( "lda #<displ0	; DISPLAYDOUBLE" );
			WriteInstruction( "sta z80_c" );
		...
		case INS_TRIPLEDIGITS:
			WriteInstruction( "lda #<displ0	; DISPLAYTRIPLE" );
			WriteInstruction( "sta z80_c" );
			WriteInstruction( "lda #>displ0" );
			WriteInstruction( "sta z80_b" );
			CompileArgument();
...
void CR_Other( void )
{
	WriteInstruction( "lda skptr	; OTHER" );
...
void CR_Spawned( void )
{
	WriteInstruction( "lda spptr	; SPAWNED" );
	WriteInstruction( "sta z80_x" );
...
void CR_Original( void )
{
	WriteInstruction( "lda ogptr	; ENDSPRITE" );
	WriteInstruction( "sta z80_x" );
...
void CR_Data( void )
{
	...
	if ( cData == 0 )
	{
		...
		if ( SpriteEvent() )
		{
			...
			WriteInstructionAndLabel( szInstruction );
			WriteInstruction( "lda (z80_ix),y" );
			sprintf( szInstruction, "cmp #%02d",nList );
			WriteInstruction( szInstruction );
			WriteInstruction( "bne :+" );
			WriteInstruction( "lda #0");
			WriteText( "\n:" );
		...
		else
		{
			...
			WriteInstruction( szInstruction );
			sprintf( szInstruction, "lda rptr%2d",nEvent );
			WriteInstruction( szInstruction );
			sprintf( szInstruction, "cmp #%02d",nList );
			WriteInstruction( szInstruction );
			WriteInstruction( "bne :+" );
			WriteInstruction( "lda #0");
			sprintf( szInstruction, "sta rptr%2d",nEvent );
			WriteInstruction( szInstruction );
			WriteText( "\n:" );
		}
...
void CR_Restore( void )
{
	...
	if ( SpriteEvent() )
	{
		WriteInstruction( "lda #0	; RESTORE" );				/* set data pointer to beyond range. */
		WriteInstruction( "ldy #16" );
		WriteInstruction( "sta (z80_ix),y" );
	}
	else
	{
		WriteInstruction( "lda #0	; RESTORE" );
...
void CR_ParticleUp( void )
{
	WriteInstruction( "ldy #3	; PARTICLEUP" );
	WriteInstruction( "lda (z80_ix),y" );
	WriteInstruction( "sec" );
	WriteInstruction( "sbc #1" );
	WriteInstruction( "sta (z80_ix),y" );
...
void CR_ParticleDown( void )
{
	WriteInstruction( "ldy #3	; PARTICLEDOWN" );
	WriteInstruction( "lda (z80_ix),y" );
	WriteInstruction( "clc" );
	WriteInstruction( "adc #1" );
	WriteInstruction( "sta (z80_ix),y" );
...
void CR_ParticleLeft( void )
{
	WriteInstruction( "ldy #5	; PARTICLELEFT" );
	WriteInstruction( "lda (z80_ix),y" );
	WriteInstruction( "sec" );
	WriteInstruction( "sbc #1" );
	WriteInstruction( "sta (z80_ix),y" );
...
void CR_ParticleRight( void )
{
	WriteInstruction( "ldy #5	; PARTICLERIGHT" );
	WriteInstruction( "lda (z80_ix),y" );
	WriteInstruction( "clc" );
	WriteInstruction( "adc #1" );
	WriteInstruction( "sta (z80_ix),y" );
...
void CR_ParticleTimer( void )
{
	WriteInstruction( "ldy #1	; PARTICLEDECAY" );
	WriteInstruction( "lda (z80_ix),y" );
	WriteInstruction( "sec" );
	WriteInstruction( "sbc #1" );
	WriteInstruction( "sta (z80_ix),y" );
...
void CR_StartParticle( void )
{
	WriteInstruction( "lda z80_i	; NEWPARTICLE" );
	WriteInstruction( "pha" );
...
void CR_UndoSpriteMove( void )
{
	WriteInstruction( "ldy #3	; UNDOSPRITEMOVE" );
	WriteInstruction( "lda (z80_ix),y" );
...
void CR_Ticker( void )
{
	...
	if ( nArg1 == INS_NUM )									/* first argument is numeric. */
	{
		...
		if ( nArg1 == 0 )
		{
			WriteInstruction( "lda #96	; TICKER" );  // RTS opcode
...
void WriteJPNZ( void )
{
	...
	switch ( nLastOperator )
	{
		case OPE_NOT:
			...
			break;
		case OPE_GRTEQU:
			WriteInstruction( "beq *+7" );					/* test succeeded, skip jp nc instruction */
